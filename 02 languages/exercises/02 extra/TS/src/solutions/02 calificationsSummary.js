...
var getAverageCalification = function (califications) {
    var sum = function (total, calification) { return total = total + calification; };
    var average = califications.reduce(sum) / califications.length;
    return parseFloat(average.toPrecision(3));
};
var getTopCalification = function (califications) {
    var compare = function (highest, calification) {
...
var summarizeStudent = function (student) {
    return {
        name: student.name,
